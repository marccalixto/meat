...
export class OrderComponent implements OnInit {
  ...
  ngOnInit() {
    this.orderForm = this.formBuilder.group({
      ...
      logradouroNumero: this.formBuilder.control('', [Validators.required, Validators.pattern(this.numberPattern)]),
  ...
  checkOrder(order: Order){
    order.orderItems = this.cartItems().map((item:CartItem) => new OrderItem(item.quantity, item.item.id))
